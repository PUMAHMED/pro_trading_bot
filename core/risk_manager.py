...
def calculate_position_size(
    ...
    entry_price: float,
    stop_loss: float,
    account_size: float = 1000,  # Default $1000
    ...
    if risk_percent is None:
        risk_percent = self.config.POSITION_SIZE_PERCENT / 10  # %1 risk
...
def assess_portfolio_risk(
    ...
    # Overexposure kontrolü
    is_overexposed = (
        position_count > self.config.MAX_OPEN_POSITIONS or
        total_risk > 20  # Portfolio'nun %20'sinden fazla risk
    )
